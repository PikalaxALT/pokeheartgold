...
_021FA1DE:
	...
	ldr r1, [r5, r0]
	lsl r2, r1, #2
	ldr r1, _021FA4B0 ; =ov15_02200640 + 1
	ldrb r1, [r1, r2]
	str r1, [r5, r0]
	b _021FA38C
_021FA1F4:
	...
	ldr r3, _021FA4B4 ; =ov15_02200640 + 2
	ldr r1, [r5, r1]
	lsl r6, r1, #2
	ldrb r3, [r3, r6]
	cmp r3, #0xe
...
_021FA246:
	...
	beq _021FA29A
	ldr r1, _021FA4A8 ; =0x00000644
	ldr r2, _021FA4B8 ; =ov15_02200640 + 3
	ldr r1, [r5, r1]
	lsl r3, r1, #2
	ldrb r2, [r2, r3]
	cmp r2, #0xf
...
_021FA4B0: .word ov15_02200640 + 1
_021FA4B4: .word ov15_02200640 + 2
_021FA4B8: .word ov15_02200640 + 3
...
ov15_021FA650: ; 0x021FA650
	...
	tst r1, r2
	beq _021FA67C
	ldr r3, _021FA684 ; =ov15_02201480
	ldr r1, [r3]
	add r4, r1, #1
	ldr r1, _021FA688 ; =ov15_02201300
	str r4, [r3]
	ldr r2, [r1]
	cmp r4, r2
	blt _021FA672
...
_021FA684: .word ov15_02201480
_021FA688: .word ov15_02201300
...
_021FAD3C:
	...
	beq _021FAD4C
	lsl r1, r0, #2
	ldr r0, _021FAD74 ; =ov15_02200584 + 1
	ldrb r0, [r0, r1]
	sub r0, #8
	bx lr
_021FAD4C:
	...
	beq _021FAD5C
	lsl r1, r0, #2
	ldr r0, _021FAD78 ; =ov15_02200584 + 2
	ldrb r0, [r0, r1]
	sub r0, #8
	bx lr
_021FAD5C:
	...
	beq _021FAD6A
	lsl r1, r0, #2
	ldr r0, _021FAD7C ; =ov15_02200584 + 3
	ldrb r0, [r0, r1]
	sub r0, #8
_021FAD6A:
	bx lr
...
_021FAD74: .word ov15_02200584 + 1
_021FAD78: .word ov15_02200584 + 2
_021FAD7C: .word ov15_02200584 + 3
...
ov15_021FB14C: ; 0x021FB14C
	push {r3, r4, r5, r6, r7, lr}
	sub sp, #8
	ldr r1, _021FB370 ; =ov15_022004EC
	add r4, r0, #0
	ldrb r2, [r1]
	add r0, sp, #0
	strb r2, [r0]
...
_021FB40C:
	...
	tst r2, r0
	beq _021FB41A
	ldr r0, _021FB504 ; =ov15_02200528 + 1
	lsl r2, r1, #2
	ldrb r4, [r0, r2]
	b _021FB434
_021FB41A:
	...
	tst r2, r0
	beq _021FB428
	ldr r0, _021FB508 ; =ov15_02200528 + 2
	lsl r2, r1, #2
	ldrb r4, [r0, r2]
	b _021FB434
_021FB428:
	...
	tst r0, r2
	beq _021FB434
	ldr r0, _021FB50C ; =ov15_02200528 + 3
	lsl r2, r1, #2
	ldrb r4, [r0, r2]
_021FB434:
	cmp r4, r1
...
_021FB504: .word ov15_02200528 + 1
_021FB508: .word ov15_02200528 + 2
_021FB50C: .word ov15_02200528 + 3
...
_021FC43E:
	...
	ldr r1, [r5, r0]
	lsl r2, r1, #2
	ldr r1, _021FC718 ; =ov15_02200640 + 1
	ldrb r1, [r1, r2]
	str r1, [r5, r0]
	b _021FC56E
_021FC454:
	...
	ldr r3, _021FC71C ; =ov15_02200640 + 2
	ldr r1, [r5, r1]
	lsl r6, r1, #2
	ldrb r3, [r3, r6]
	cmp r3, #0xe
...
_021FC4AC:
	...
	beq _021FC506
	ldr r1, _021FC710 ; =0x00000644
	ldr r2, _021FC720 ; =ov15_02200640 + 3
	ldr r1, [r5, r1]
	lsl r3, r1, #2
	ldrb r2, [r2, r3]
	cmp r2, #0xf
...
_021FC718: .word ov15_02200640 + 1
_021FC71C: .word ov15_02200640 + 2
_021FC720: .word ov15_02200640 + 3
...
_022004E8: .word ManagedSprite_SetDrawFlag
	...
	.global ov15_022004EC
ov15_022004EC:
	.byte 0xFF, 0xFF, 0xFF, 0xFF
	.byte 0xFF, 0x00, 0x00, 0x00
	.size ov15_022004EC,.-ov15_022004EC
...
ov15_02200B0C: ; 0x02200B0C
	...
	.global ov15_02201300
ov15_02201300:
	.byte 0x01, 0x00, 0x00, 0x00
	.size ov15_02201300,.-ov15_02201300
...
ov15_02201468: ; 0x02201468
	...
	.global ov15_02201480
ov15_02201480:
	.space 4
	.size ov15_02201480,.-ov15_02201480
