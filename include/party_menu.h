...
typedef enum PartyMenuContext {
    PARTY_MENU_CONTEXT_FIELD,
    PARTY_MENU_CONTEXT_BATTLE,
    PARTY_MENU_CONTEXT_UNION_ROOM_BATTLE_SELECT,
    PARTY_MENU_CONTEXT_SELECT_MON_NO_PROMPT,
    ...
    PARTY_MENU_CONTEXT_GIVE_ITEM,
    PARTY_MENU_CONTEXT_GIVE_ITEM_DONE,
    PARTY_MENU_CONTEXT_GIVE_MAIL,
    PARTY_MENU_CONTEXT_GIVE_MAIL_DONE,
    ...
    PARTY_MENU_CONTEXT_BATTLE_TOWER,
    PARTY_MENU_CONTEXT_DAYCARE,
    PARTY_MENU_CONTEXT_INGAME_TRADE,
    PARTY_MENU_CONTEXT_FEED_POFFIN,
    PARTY_MENU_CONTEXT_SPIN_TRADE,
    PARTY_MENU_CONTEXT_BATTLE_HALL,
    PARTY_MENU_CONTEXT_BATTLE_CASTLE,
} PartyMenuContext;
